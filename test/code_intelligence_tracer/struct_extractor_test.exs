defmodule CodeIntelligenceTracer.StructExtractorTest do
  ...
  describe "extract_struct/1 with real BEAM data" do
    test "extracts struct from Stats module" do
      ...
      {:ok, debug_info} =
        CodeIntelligenceTracer.BeamReader.extract_debug_info(chunks, module)
    ...
    test "returns nil for non-struct module" do
      beam_path =
        "_build/dev/lib/code_search_elixir_tracer/ebin/Elixir.CodeIntelligenceTracer.CLI.beam"
