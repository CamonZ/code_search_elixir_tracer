defmodule ExAst.Extractor.FunctionExtractorIntegrationTest do
  ...
  describe "extract_functions/2 with macro-generated functions" do
    test "detects macro-generated functions via context metadata" do
      ...
      struct_entries =
        Enum.filter(functions, fn {key, _} -> String.starts_with?(key, "__struct__/") end)
    ...
    test "regular functions can have end_line > line" do
      ...
      {_key, func_info} =
        Enum.find(functions, fn {key, _} -> String.starts_with?(key, "record_success/6:") end)
